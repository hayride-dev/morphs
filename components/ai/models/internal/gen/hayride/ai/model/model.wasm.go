...
//go:wasmimport [export]hayride:ai/model@0.0.57 [resource-new]error
//go:noescape
func wasmimport_ErrorResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.57 [resource-rep]error
//go:noescape
func wasmimport_ErrorResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.57 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmexport hayride:ai/model@0.0.57#[dtor]error
//export hayride:ai/model@0.0.57#[dtor]error
...
//go:wasmexport hayride:ai/model@0.0.57#[method]error.code
//export hayride:ai/model@0.0.57#[method]error.code
...
//go:wasmexport hayride:ai/model@0.0.57#[method]error.data
//export hayride:ai/model@0.0.57#[method]error.data
...
//go:wasmimport [export]hayride:ai/model@0.0.57 [resource-new]format
//go:noescape
func wasmimport_FormatResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.57 [resource-rep]format
//go:noescape
func wasmimport_FormatResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.57 [resource-drop]format
//go:noescape
func wasmimport_FormatResourceDrop(self0 uint32)

//go:wasmexport hayride:ai/model@0.0.57#[dtor]format
//export hayride:ai/model@0.0.57#[dtor]format
...
//go:wasmexport hayride:ai/model@0.0.57#[constructor]format
//export hayride:ai/model@0.0.57#[constructor]format
...
//go:wasmexport hayride:ai/model@0.0.57#[method]format.decode
//export hayride:ai/model@0.0.57#[method]format.decode
...
//go:wasmexport hayride:ai/model@0.0.57#[method]format.encode
//export hayride:ai/model@0.0.57#[method]format.encode
