...
// Exports represents the caller-defined exports from "hayride:ai/model@0.0.57".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/model@0.0.57#error".
	Error struct {
	...
	// Format represents the caller-defined exports for resource "hayride:ai/model@0.0.57#format".
	Format struct {
