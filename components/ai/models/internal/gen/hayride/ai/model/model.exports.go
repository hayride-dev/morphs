...
// Exports represents the caller-defined exports from "hayride:ai/model@0.0.60".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/model@0.0.60#error".
	Error struct {
	...
	// Format represents the caller-defined exports for resource "hayride:ai/model@0.0.60#format".
	Format struct {
