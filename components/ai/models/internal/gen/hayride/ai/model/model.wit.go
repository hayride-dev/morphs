...
// Package model represents the exported interface "hayride:ai/model@0.0.59".
package model
...
// Error represents the exported resource "hayride:ai/model@0.0.59#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.59#format".
//
//	resource format
