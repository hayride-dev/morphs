...
// Package model represents the exported interface "hayride:ai/model@0.0.60".
package model
...
// Error represents the exported resource "hayride:ai/model@0.0.60#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.60#format".
//
//	resource format
