...
// Package model represents the exported interface "hayride:ai/model@0.0.57".
package model
...
// Error represents the exported resource "hayride:ai/model@0.0.57#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.57#format".
//
//	resource format
