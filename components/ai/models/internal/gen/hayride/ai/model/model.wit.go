...
// Package model represents the exported interface "hayride:ai/model@0.0.56".
package model
...
// Error represents the exported resource "hayride:ai/model@0.0.56#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.56#format".
//
//	resource format
