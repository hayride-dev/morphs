...
//go:wasmimport hayride:ai/inference-stream@0.0.56 [resource-drop]graph-execution-context-stream
//go:noescape
func wasmimport_GraphExecutionContextStreamResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/inference-stream@0.0.56 [method]graph-execution-context-stream.compute
//go:noescape
