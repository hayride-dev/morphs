...
// Package types represents the imported interface "hayride:ai/types@0.0.55".
package types
...
// Role represents the enum "hayride:ai/types@0.0.55#role".
//
//	enum role {
//		user,
//		assistant,
...
// TextContent represents the record "hayride:ai/types@0.0.55#text-content".
//
//	record text-content {
//		text: string,
//		content-type: string,
...
// ToolSchema represents the record "hayride:ai/types@0.0.55#tool-schema".
//
//	record tool-schema {
//		id: string,
//		name: string,
...
// ToolInput represents the record "hayride:ai/types@0.0.55#tool-input".
//
//	record tool-input {
//		content-type: string,
//		id: string,
...
// ToolOutput represents the record "hayride:ai/types@0.0.55#tool-output".
//
//	record tool-output {
//		content-type: string,
//		id: string,
...
// Content represents the variant "hayride:ai/types@0.0.55#content".
//
//	variant content {
//		none,
//		text(text-content),
...
// Message represents the record "hayride:ai/types@0.0.55#message".
//
//	record message {
//		role: role,
