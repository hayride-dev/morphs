...
// Exports represents the caller-defined exports from "hayride:ai/tools@0.0.60".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/tools@0.0.60#error".
	Error struct {
	...
	// Tools represents the caller-defined exports for resource "hayride:ai/tools@0.0.60#tools".
	Tools struct {
