...
// Package tools represents the exported interface "hayride:ai/tools@0.0.59".
package tools
...
// Error represents the exported resource "hayride:ai/tools@0.0.59#error".
//
//	resource error
...
// Tools represents the exported resource "hayride:ai/tools@0.0.59#tools".
//
//	resource tools
