...
// Package tools represents the exported interface "hayride:ai/tools@0.0.60".
package tools
...
// Error represents the exported resource "hayride:ai/tools@0.0.60#error".
//
//	resource error
...
// Tools represents the exported resource "hayride:ai/tools@0.0.60#tools".
//
//	resource tools
