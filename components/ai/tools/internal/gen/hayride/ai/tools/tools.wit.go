...
// Package tools represents the exported interface "hayride:ai/tools@0.0.55".
package tools
...
// Error represents the exported resource "hayride:ai/tools@0.0.55#error".
//
//	resource error
...
// Tools represents the exported resource "hayride:ai/tools@0.0.55#tools".
//
//	resource tools
