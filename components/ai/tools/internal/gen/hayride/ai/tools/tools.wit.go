...
// Package tools represents the exported interface "hayride:ai/tools@0.0.56".
package tools
...
// Error represents the exported resource "hayride:ai/tools@0.0.56#error".
//
//	resource error
...
// Tools represents the exported resource "hayride:ai/tools@0.0.56#tools".
//
//	resource tools
