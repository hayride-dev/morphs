...
//go:wasmimport hayride:ai/graph-stream@0.0.61 [resource-drop]graph-stream
//go:noescape
func wasmimport_GraphStreamResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/graph-stream@0.0.61 [method]graph-stream.init-execution-context-stream
//go:noescape
...
//go:wasmimport hayride:ai/graph-stream@0.0.61 load-by-name
//go:noescape
