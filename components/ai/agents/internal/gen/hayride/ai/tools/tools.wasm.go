...
//go:wasmimport hayride:ai/tools@0.0.60 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/tools@0.0.60 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/tools@0.0.60 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:ai/tools@0.0.60 [resource-drop]tools
//go:noescape
func wasmimport_ToolsResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/tools@0.0.60 [constructor]tools
//go:noescape
func wasmimport_NewTools() (result0 uint32)

//go:wasmimport hayride:ai/tools@0.0.60 [method]tools.call
//go:noescape
...
//go:wasmimport hayride:ai/tools@0.0.60 [method]tools.capabilities
//go:noescape
