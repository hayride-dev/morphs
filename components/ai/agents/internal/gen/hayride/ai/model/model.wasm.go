...
//go:wasmimport hayride:ai/model@0.0.55 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/model@0.0.55 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/model@0.0.55 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:ai/model@0.0.55 [resource-drop]format
//go:noescape
func wasmimport_FormatResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/model@0.0.55 [constructor]format
//go:noescape
func wasmimport_NewFormat() (result0 uint32)

//go:wasmimport hayride:ai/model@0.0.55 [method]format.decode
//go:noescape
func wasmimport_FormatDecode(self0 uint32, raw0 *uint8, raw1 uint32, result *cm.Result[MessageShape, Message, Error])

//go:wasmimport hayride:ai/model@0.0.55 [method]format.encode
//go:noescape
