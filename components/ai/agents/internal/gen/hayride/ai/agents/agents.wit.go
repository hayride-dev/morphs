...
// Package agents represents the exported interface "hayride:ai/agents@0.0.57".
package agents
...
// Context represents the exported type alias "hayride:ai/agents@0.0.57#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Format represents the exported type alias "hayride:ai/agents@0.0.57#format".
//
// See [model.Format] for more information.
type Format = model.Format

// Tools represents the exported type alias "hayride:ai/agents@0.0.57#tools".
//
// See [tools.Tools] for more information.
type Tools = tools.Tools

// GraphStream represents the exported type alias "hayride:ai/agents@0.0.57#graph-stream".
//
// See [graphstream.GraphStream] for more information.
type GraphStream = graphstream.GraphStream

// GraphExecutionContextStream represents the exported type alias "hayride:ai/agents@0.0.57#graph-execution-context-stream".
//
...
// OutputStream represents the exported type alias "hayride:ai/agents@0.0.57#output-stream".
//
...
// Error represents the exported resource "hayride:ai/agents@0.0.57#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agents@0.0.57#agent".
//
//	resource agent
