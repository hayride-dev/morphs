...
// Package agents represents the exported interface "hayride:ai/agents@0.0.55".
package agents
...
// Context represents the exported type alias "hayride:ai/agents@0.0.55#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Format represents the exported type alias "hayride:ai/agents@0.0.55#format".
//
// See [model.Format] for more information.
type Format = model.Format

// Tools represents the exported type alias "hayride:ai/agents@0.0.55#tools".
//
// See [tools.Tools] for more information.
type Tools = tools.Tools

// GraphExecutionContextStream represents the exported type alias "hayride:ai/agents@0.0.55#graph-execution-context-stream".
//
...
// OutputStream represents the exported type alias "hayride:ai/agents@0.0.55#output-stream".
//
...
// Error represents the exported resource "hayride:ai/agents@0.0.55#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agents@0.0.55#agent".
//
//	resource agent
