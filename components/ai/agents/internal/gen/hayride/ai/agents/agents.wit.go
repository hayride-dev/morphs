...
// Package agents represents the exported interface "hayride:ai/agents@0.0.59".
package agents
...
// Context represents the exported type alias "hayride:ai/agents@0.0.59#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Format represents the exported type alias "hayride:ai/agents@0.0.59#format".
//
// See [model.Format] for more information.
type Format = model.Format

// Tools represents the exported type alias "hayride:ai/agents@0.0.59#tools".
//
// See [tools.Tools] for more information.
type Tools = tools.Tools

// GraphStream represents the exported type alias "hayride:ai/agents@0.0.59#graph-stream".
//
// See [graphstream.GraphStream] for more information.
type GraphStream = graphstream.GraphStream

// GraphExecutionContextStream represents the exported type alias "hayride:ai/agents@0.0.59#graph-execution-context-stream".
//
...
// OutputStream represents the exported type alias "hayride:ai/agents@0.0.59#output-stream".
//
...
// Error represents the exported resource "hayride:ai/agents@0.0.59#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agents@0.0.59#agent".
//
//	resource agent
